...
/// <reference path="~/www/pages/overview/overviewController.js" />

(function () {
    "use strict";

    var pageName = Application.getPagePath("overview");
    WinJS.Namespace.define("Application.OverviewLayout", {
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            this.controller = new Overview.Controller(element, commandList);
