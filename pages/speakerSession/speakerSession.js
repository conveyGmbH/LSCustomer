...
/// <reference path="~/www/pages/speakerSession/speakerSessionController.js" />

(function () {
    "use strict";

    var pageName = Application.getPagePath("speakerSession");
    ...
    WinJS.UI.Pages.define(pageName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [];
            this.controller = new SpeakerSession.Controller(element, commandList);
