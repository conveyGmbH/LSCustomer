...
/// <reference path="~/www/fragments/teaser/teaserController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("teaser");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [];
            this.controller = new Teaser.Controller(element, options, commandList);
