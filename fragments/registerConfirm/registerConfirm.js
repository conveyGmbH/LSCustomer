...
/// <reference path="~/www/fragments/registerConfirm/registerConfirmController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("registerConfirm");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [];
            this.controller = new RegisterConfirm.Controller(element, options, commandList);
