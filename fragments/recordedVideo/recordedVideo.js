...
/// <reference path="~/www/fragments/recordedVideo/recordedVideoController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("recordedVideo");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [];
            this.controller = new RecordedVideo.Controller(element, options, commandList);
