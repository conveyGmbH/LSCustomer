...
/// <reference path="~/www/fragments/countdown/countdownController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("countdown");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [];
            this.controller = new Countdown.Controller(element, options, commandList);
