...
/// <reference path="~/www/fragments/maintenance/maintenanceController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("maintenance");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [];
            this.controller = new Maintenance.Controller(element, options, commandList);
