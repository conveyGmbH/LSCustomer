...
/// <reference path="~/www/fragments/register/registerController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("register");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [];
            this.controller = new Register.Controller(element, options, commandList);
