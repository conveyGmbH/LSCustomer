// controller for page: nonRecordedEvent
...
/// <reference path="~/www/fragments/nonRecordedContent/NonRecordedContentService.js" />
...
(function () {
    ...
    WinJS.Namespace.define("NonRecordedContent", {
        Controller: WinJS.Class.derive(Fragments.Controller, function Controller(fragmentElement, options, commandList) {
            Log.call(Log.l.trace, "NonRecordedContent.Controller.", "eventId=" + (options && options.eventId));
            ...
            var loadData = function () {
                Log.call(Log.l.trace, "NonRecordedContent.Controller.");
