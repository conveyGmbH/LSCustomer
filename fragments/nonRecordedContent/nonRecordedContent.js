...
/// <reference path="~/www/fragments/nonRecordedContent/nonRecordedContentController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("nonRecordedContent");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [];
            this.controller = new NonRecordedContent.Controller(element, options, commandList);
