...
/// <reference path="~/www/fragments/contentRecordedOnlyRegister/contentRecordedOnlyRegisterController.js" />

(function () {
    "use strict";

    var fragmentName = Application.getFragmentPath("contentRecordedOnlyRegister");
    ...
    Fragments.define(fragmentName, {
        ...
        ready: function (element, options) {
            ...
            var commandList = [];
            this.controller = new ContentRecordedOnlyRegister.Controller(element, options, commandList);
