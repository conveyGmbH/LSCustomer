...
(function () {
  ...
  /**
    ...
    *
  */
  var initChatTimeline = function (Popcorn) {
      if (!Popcorn) {
          window.setTimeout(function() {
              initChatTimeline(window.Popcorn);
          }, 50);
          return;
      }
      var i = 1;

      Popcorn.plugin("chattimeline",
          function(options) {
              ...
              return {
                  ...
                  _teardown: function(options) {
                      ...
                      return (target && contentDiv) && target.removeChild(contentDiv) && !target.firstChild;
                  }
              };
          },
          {
