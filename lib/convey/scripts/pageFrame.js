            ...
            function PageFrame(aName) {
                ...
                checkForResources: function (language, complete, error) {
                    ...
                    Application.pageframe.loadLocalResources(language, function () {
                        ...
                        if (AppData._persistentStates.loadRemoteResource) {
                            Application.pageframe.loadRemoteResource(AppData.getIdFromLanguage(language), function() {
                                complete();
                            },
                            function(err) {
                ...
                post_initialize: function() {
                    ...
                    var p = ui.processAll().then(function () {
                        ...
                        return Application.navigateById(Application.getPageId(startPage), nav.state);
                    }).then(function () {
