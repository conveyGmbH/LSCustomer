            ...
            function PageFrame(aName) {
                ...
                initialize: function () {
                    ...
                    if (Application.theme) {
                        AppData._persistentStates.isDarkTheme = (Application.theme === "dark") ? true : false;
                    } else if (typeof AppData._persistentStates.isDarkTheme === "undefined") {
                ...
                post_initialize: function() {
                    ...
                    var p = ui.processAll().then(function () {
                        ...
                        var startPageId = Application.query && Application.query.page || 
