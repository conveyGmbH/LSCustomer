    ...
    WinJS.Namespace.define("Colors", {
                    ...
                    if (sheet) {
                        for (var prop in sheet) {
                            if (sheet.hasOwnProperty(prop)) {
                                if (prop === "rules") { //sheet["rules"]
                                    cssRules = "rules";
                                } else if (prop === "cssRules") { //sheet["cssRules"]
                                    cssRules = "cssRules";
                                } else if (prop === "ownerRule") { //sheet["ownerRule]"
                                    cssRules = "ownerRule";
                                } else {
                                    cssRules = null;
                                }
        ...
        ColorsClass: WinJS.Class.define(
            ...
            function ColorsClass(colorSettings, forceColors) {
                ...
                var masterHostBackgroundColor = Colors.rgb2hex(masterHostBackgroundColorRgb.r, masterHostBackgroundColorRgb.g, masterHostBackgroundColorRgb.b);
                ...
                WinJS.Promise.timeout(500).then(function () {
                    ...
                    Colors.changeCSS(".masterhost-container .pagecontrol", "background-color", masterHostBackgroundColor);
                    Colors.changeCSS(".masterhost-background", "background-color", masterHostBackgroundColor);
