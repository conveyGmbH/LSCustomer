                ...
                if (Colors._prevIsDarkTheme !== null && Colors._prevIsDarkTheme === Colors.isDarkTheme) {
                    ...
                    if (Colors.isDarkTheme) {
                        loadCssPromise = loadCssPromise.then(function() {
                            return Colors.loadCSSfile("lib/WinJS/css/ui-dark.min.css");
                        }).then(function() {
                        ...
                        loadCssPromise = loadCssPromise.then(function() {
                            return Colors.loadCSSfile("lib/WinJS/css/ui-light.min.css");
                        }).then(function() {
                            if (WinJS.Utilities.hasClass(document.body, "cnv-ui-dark")) {
                    ...
                    loadCssPromise = loadCssPromise.then(function() {
                        return Colors.loadCSSfile("css/opensans.css");
                    }).then(function() {
